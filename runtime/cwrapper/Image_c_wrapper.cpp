...
typedef enum {
    ONE_DIM_INTERP_CONSTANT = 1,
    ONE_DIM_INTERP_LINEAR = 2,
    ONE_DIM_INTERP_BEZIER = 3,
    ONE_DIM_INTERP_BSPLINE = 4,
} OneDimInterpC;

typedef enum {
    TWO_DIM_INTERP_NEAREST = 101,
    TWO_DIM_INTERP_BILINEAR = 102,
    TWO_DIM_INTERP_BICUBIC = 103,
    TWO_DIM_INTERP_FOURIER = 104,
    TWO_DIM_INTERP_EDGE = 105,
    TWO_DIM_INTERP_HQX = 106,
    TWO_DIM_INTERP_MIPMAP = 107,
} TwoDimInterpC;
}
